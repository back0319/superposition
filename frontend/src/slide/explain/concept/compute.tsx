          ...
          <div className="content-section">
            ...
            <div className="section-content">
              <p>
                ...
                <strong>큐비트(qubit)</strong>라는 양자 정보의 기본 단위를 사용합니다.
              </p>
              <p>
                큐비트의 가장 놀라운 특성은 <strong>중첩(superposition)</strong>과 <strong>얽힘(entanglement)</strong>입니다. 
          ...
          <div className="content-section">
            ...
            <div className="section-content">
              <p>
                ...
                양자 컴퓨터는 <strong>양자 게이트(quantum gate)</strong>를 통해 큐비트의 상태를 조작합니다.
              </p>
              <p>
              ...
              <ul>
                <li><strong>초기화:</strong> 큐비트들을 특정 초기 상태로 설정합니다.</li>
                <li><strong>양자 게이트 적용:</strong> 하다마드 게이트, CNOT 게이트 등을 통해 큐비트 상태를 조작합니다.</li>
                <li><strong>얽힘 생성:</strong> 여러 큐비트 사이에 양자 얽힘을 만들어 복잡한 양자 상태를 구성합니다.</li>
                <li><strong>측정:</strong> 최종적으로 큐비트의 상태를 측정하여 고전적인 정보로 변환합니다.</li>
              </ul>
            </div>
          </div>
